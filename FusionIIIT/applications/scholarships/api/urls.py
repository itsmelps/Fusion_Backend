...
urlpatterns = [
    ...
    path('singleparent_show/', views.single_parent_show),
    path('singleparent_update/', views.single_parent_update),
    path('singleparent_list/', views.single_parent_list),
    path('api/singleparent/decision/', views.single_parent_decision),
